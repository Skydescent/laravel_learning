...
class PostEloquentRepository extends  EloquentRepository //implements TaggableInterface, CommentableInterface
{
    ...
    public function find(callable $getModel, array $identifier, User|Authenticatable|null $user = null): mixed
    {
        Log::info('PostsEloquentRepository@find: ' . implode(',' , $identifier) . ' user: ' . $user);
